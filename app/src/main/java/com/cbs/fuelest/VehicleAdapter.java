...
import com.cbs.fuelest.databinding.ItemVehicleBinding;
...
public class VehicleAdapter extends RecyclerView.Adapter<VehicleAdapter.ViewHolder> {
    ...
    public VehicleAdapter(List<VehicleItem> items, FuelViewModel viewModel) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.binding.setVehicle(items.get(position));
